						...
						<div class="row">
							...
							<div class="col-md-3 pull-right">
								...
								<select name="status_work[]" class="selectpicker" multiple="true" id="status_work" data-width="100%" data-none-selected-text="<?php echo _l('hr_status_label'); ?>"> 
									...
									<option value="probation"><?php echo _l('Probation'); ?></option>
									<option value="permanent"><?php echo _l('Permanent'); ?></option>

									<option value="contract"><?php echo _l('Contract'); ?></option>

									<option value="temporary"><?php echo _l('Temporary'); ?></option>

									<option value="notice_period"><?php echo _l('Notice period'); ?></option>

									<option value="terminated"><?php echo _l('Terminated'); ?></option>

									<option value="resigned"><?php echo _l('Resigned'); ?></option>
