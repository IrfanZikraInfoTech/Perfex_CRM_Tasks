							...
							<div class="tab-content">
									...
									<div class="row">
										...
										<div class="form-group">
											...
											<select name="status_work" class="selectpicker" id="status_work" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
												<option value="working" <?php if (isset($member) && $member->status_work == 'working') { echo 'selected'; } ?>><?php echo _l('hr_working'); ?></option>

												<option value="maternity leave" <?php if (isset($member) && $member->status_work == 'maternity leave') { echo 'selected'; } ?>><?php echo _l('hr_maternity_leave'); ?></option>

												<option value="probation" <?php if (isset($member) && $member->status_work == 'probation') { echo 'selected'; } ?>><?php echo _l('Probation'); ?></option>

												<option value="permanent" <?php if (isset($member) && $member->status_work == 'permanent') { echo 'selected'; } ?>><?php echo _l('Permanent'); ?></option>
												
												<option value="temporary" <?php if (isset($member) && $member->status_work == 'temporary') { echo 'selected'; } ?>><?php echo _l('Temporary'); ?></option>

												<option value="notice period" <?php if (isset($member) && $member->status_work == 'notice period') { echo 'selected'; } ?>><?php echo _l('Notice period'); ?></option>

												<option value="terminated" <?php if (isset($member) && $member->status_work == 'terminated') { echo 'selected'; } ?>><?php echo _l('Terminated'); ?></option>

												<option value="resigned" <?php if (isset($member) && $member->status_work == 'resigned') { echo 'selected'; } ?>><?php echo _l('Resigned'); ?></option>
											</select>
										</div>
								...
								<div class="row">
									...
									<div class="form-group" app-field-wrapper="work_experience">
										<label for="work_experience" class="control-label"><?php echo _l('Work Experience'); ?></label>
										<textarea id="work_experience" name="work_experience" class="form-control" autocomplete="off" <?php if(!is_admin() && !has_permission('hrm_hr_records','', 'edit') && !has_permission('hrm_hr_records','', 'create')){ echo 'disabled' ;}  ?>><?php echo html_entity_decode($work_experience_value); ?></textarea>
									</div>
