					...
					<div class="panel_s mbot5">
						...
						<div class="panel-body padding-10">
							...
							<?php
								...
								// Display the full name with the custom HR code
								echo html_entity_decode($member->firstname . ' ' . $member->lastname . ' ' . (($hr_codes != '') ? ' - ' . $hr_codes : ''));
							?>
						...
						foreach($tab as $group_item){
							...
							<a href="<?php echo admin_url('hr_profile/member/'.$staffid.'/'.$group_item); ?>" data-group="<?php echo html_entity_decode($group_item); ?>">
								...
								<?php
									...
									$icon['dependent_person'] = '<span class="glyphicon glyphicon-user"></span>'; 
									$icon['training'] = '<span class="glyphicon glyphicon-education"></span>'; // Closest match in Glyphicons
									$icon['bonus_discipline'] = '<span class="glyphicon glyphicon-gift"></span>'; // 'bell' icon does not exist in Glyphicons, 'gift' can be an alternative
									$icon['attach'] = '<span class="glyphicon glyphicon-paperclip"></span>'; // Paperclip can represent an attachment
									$icon['staff_project'] = '<span class="glyphicon glyphicon-tasks"></span>'; // Used 'tasks' as there is no direct 'bars' icon in Glyphicons
									$icon['other'] = '<span class="glyphicon glyphicon-list-alt"></span>'; // 'list-alt' can be used for miscellaneous/other
								...
								if($group_item == 'profile'){
									...
									echo html_entity_decode($icon[$group_item] .' '. _l('Attendent Training')); 
