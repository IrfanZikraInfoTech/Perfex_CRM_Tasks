        ...
        <div class="row">
            <div class="flex flex-wrap -mx-2">
                ...
                <div class="w-full lg:w-6/12 p-4">
                    <div class="bg-white p-6 rounded-[20px] shadow-xl hover:shadow-2xl border border-gray-200 transition-all duration-500 ease-in-out relative flex items-center justify-center">
                        <div class="mr-6">
                            <p id="total_permanent" class="text-3xl font-extrabold text-[rgba(40,167,69)]"><?php echo $total_permanent; ?></p>
                            <h5 class="text-lg font-medium text-uppercase mb-2  text-[rgba(40,167,69,0.6)]">Permanent Employees</h5>
                        </div>
                ...
                <div class="w-full lg:w-6/12 p-4">
                    <div class="bg-white p-6 rounded-[20px] shadow-xl hover:shadow-2xl border border-gray-200 transition-all duration-500 ease-in-out relative flex items-center justify-center">
                        <div class="mr-6">
                            ...
                            <h5 class="text-lg font-medium text-uppercase mb-2 text-[rgba(255,193,7,0.6)]">Employees On Notice Period</h5>
                        </div>
                ...
                <div class="w-full lg:w-6/12 p-4">
                    <div class="bg-white p-6 rounded-[20px] shadow-xl hover:shadow-2xl border border-gray-200 transition-all duration-500 ease-in-out relative flex items-center justify-center">
                         <div class="mr-6">
                            <p id="total_probation" class="text-3xl font-extrabold text-[#d62828] "><?php echo $total_probation; ?></p>
                            <h5 class="text-lg font-medium text-uppercase mb-2  text-[#d62828]">Employees on Probation</h5>
                        </div>
