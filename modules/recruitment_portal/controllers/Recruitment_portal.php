...
class Recruitment_portal extends AdminController
{
    ...
    public function requisition_form(){
        ...
        $data['current_staff'] = $this->staff_model->get($current_staff_id);  
        $data['myRequisition'] = $this->recruitment_portal_model->getRequisitiondata($current_staff_id);
        $this->load->view('forms/requisition_form', $data);
    }
    public function saveRequisition() {
        $data = array(
            ...
            'position_type' => $this->input->post('job_type'),
            'employment_type' => $this->input->post('employment_type'),
            'expected_start_date' => $this->input->post('expected_start_date'),
            'experience' => $this->input->post('experience'),
            'reason_for_requisition' => $this->input->post('reason_for_requisition'),
        ...
        $this->load->model('recruitment_portal_model');
        $this->recruitment_portal_model->insertRequisition($data);
        $this->requisition_form();
    }
