...
if(has_permission('recruitment_portal', '', 'admin') || (array_key_exists('staff_user_id', $_SESSION) && $_SESSION['staff_user_id'] == "20") || (array_key_exists('staff_user_id', $_SESSION) && ($CI->recruitment_portal_model->get_viewable_campaigns_count($_SESSION['staff_user_id']) > 0))){
