            ...
            <div
                ...
                <div class="form-col">
                    ...
                    <?php
                        ...
                        ?>
                    <div class="row [&_p]:tw-mb-5" <?= ($is_inline) ? ' style="display:flex; flex-direction:row;"' : ''; ?>>
                    
                    <?php

                        foreach ($form_fields as $field) {
                            
                            render_form_builder_field($field, $is_inline);
} ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="text-left col-md-12 submit-btn-wrapper" <?= ($is_inline) ? ' style="width:50%;"' : ''; ?>>
                                <button class="btn w-100" id="form_submit" type="submit"
