...
class Team_management extends AdminController {
    ...
    public function dashboard($month = null, $day = null)
    {
        ...
        $this->load->view('admin/management/team_dashboard', $data);
    }
    ...
    public function team_stats()
    {
        ...
        $this->load->view('admin/management/team_stats', $data);
    }
    ...
    public function daily_reports($month, $day)
    {
        ...
        $this->load->view('admin/management/daily_reports', $data);
    }
    ...
    public function monthly_reports($year, $month)
    {
        ...
        $this->load->view('admin/management/monthly_reports', $data);
    }
    ...
    public function project_management() {
        ...
        $this->load->view('admin/management/project_management', $data);
    }
