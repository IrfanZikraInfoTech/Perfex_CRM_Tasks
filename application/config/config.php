...
$config['csrf_exclude_uris'] = ['admin/custom_email_and_sms_notifications/email_sms/sendEmailSms', 'forms/wtl/[0-9a-z]+', 'forms/ticket', 'forms/quote/[0-9a-z]+', 'admin/tasks/timer_tracking', 'api\/.+', 'admin/recruitment_portal/submission_message_skip_auth', 'admin/recruitment_portal/capture_message_id_cron_access', 'admin/leads/capture_lead_reply_skip_auth'];
